        ...
        <div className="min-h-screen flex flex-col">
          <div className="m-20 bg-white container rounded-lg max-w-lg mx-auto flex-1 flex flex-col items-center justify-center px-2">
            <div className="px-6 py-8 rounded-lg shadow-md text-black w-full">
              <h1 className="mb-8 text-3xl text-center" style={{ color: '#6ea4d6' }}>Sign up</h1>
              ...
              <div className="text-grey-dark mt-6">
                ...
                <Link to="/" className="no-underline border-b border-blue text-blue hover:font-bold" href="../login/" style={{ color: '#6ea4d6' }}>
                  Log in
                </Link>.
              </div>
            </div>
